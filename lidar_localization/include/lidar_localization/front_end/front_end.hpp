...
class FrontEnd {
  ...
  private:
    bool InitParam(const Json::Value& config_node);
    bool InitDataPath(const Json::Value& config_node);
    bool InitRegistration(std::shared_ptr<RegistrationInterface>& registration_ptr, const Json::Value& config_node);
    bool InitFilter(std::string filter_user, std::shared_ptr<CloudFilterInterface>& filter_ptr, const Json::Value& config_node);
