...
///////////////////////////////////////////////////////////////////////////////
#ifndef LIDAR_LOCALIZATION_MODELS_REGISTRATION_SICP_ICP_H_
#define LIDAR_LOCALIZATION_MODELS_REGISTRATION_SICP_ICP_H_
...
namespace IWICP {
    ...
    /// @param Parameters
    template <typename Derived1, typename Derived2, typename Derived3>
    inline Eigen::Affine3d point_to_plane(
        Eigen::MatrixBase<Derived1>& X,
        Eigen::MatrixBase<Derived2>& Y,
        Eigen::MatrixBase<Derived3>& N,
        Parameters par = Parameters()
...
///////////////////////////////////////////////////////////////////////////////
#endif // LIDAR_LOCALIZATION_MODELS_REGISTRATION_SICP_ICP_H_
